...
namespace WebAPIAutores.Controllers.V1
{
    ...
    public class LibrosController : ControllerBase
    {
        ...
        public async Task<ActionResult> Put(int id, LibroCreacionDTO libroCreacionDTO)
        {
            ...
            /* Aca es donde se hace la actualizacion de los datos. Lo que hace AutoMapper es llevar todas la propiedades de 
             libroCracionDTO a libroDB, por lo tanto estamos actualizando la instancia del libroDB.*/
